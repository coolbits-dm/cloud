...
class CanarySLOIntegration:
    ...
    def __init__(self):
        ...
        self.canary_config = {
            ...
            "slo_thresholds": {"response_time_p95": 400, "error_rate_5xx": 1.0},
        }
    ...
    def run_canary_with_slo_check(self, service_url: str, new_image: str):
        ...
        print(
            f"📊 Monitoring SLOs for {self.canary_config['slo_check_duration']} minutes..."
        )
        ...
        while datetime.now() < end_time:
            ...
            try:
                ...
                # Record metric
                self.slo_monitor.record_response_time(
...
if __name__ == "__main__":
    ...
    result = canary.run_canary_with_slo_check(
        service_url="http://localhost:8501", new_image="coolbits-ai:v1.2.3"
    )
