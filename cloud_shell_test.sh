...
# Testează toate endpointurile pentru roluri în Cloud Shell

echo "🧪 CoolBits.ai - Testing Role-based API Endpoints in Cloud Shell"
echo "==============================================================="
echo ""
...
echo "🔍 Checking created endpoints..."
echo ""

# Verifică structura creată
echo "📁 API Roles structure:"
ls -la app/api/roles/

echo ""
echo "📁 Individual role endpoints:"
ls -la app/api/roles/*/
...
echo ""
echo "📝 Testing Marketing role endpoint: /api/roles/03"
curl -X GET http://localhost:3000/api/roles/03 \
  -H "Content-Type: application/json" \
  | jq '.'
