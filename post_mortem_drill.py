...
class PostMortemDrill:
    ...
    def _generate_drill_report(self, results):
        ...
        # Save report
        report_file = f"post_mortem_drill_report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--schedule", action="store_true", help="Setup monthly scheduling")
