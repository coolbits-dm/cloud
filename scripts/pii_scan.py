...
class PIIScanner:
    ...
    def _get_severity(self, pii_type: str) -> str:
        ...
        high_severity = {'email', 'phone', 'ssn', 'credit_card', 'password', 'api_key', 'aws_credentials', 'gcp_credentials'}
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Scan codebase for PII and sensitive data')
    parser.add_argument('--path', default='.', help='Path to scan (default: current directory)')
    parser.add_argument('--output', default='pii_scan_report.txt', help='Output file for report')
    parser.add_argument('--json', action='store_true', help='Output JSON format')
    parser.add_argument('--fail-on-high', action='store_true', help='Exit with error if high severity findings')
