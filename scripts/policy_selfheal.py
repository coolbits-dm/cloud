...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--backup-file", default="cblm/opipe/nha/out/registry.json", help="Path to backup JSON")
    p.add_argument("--check-signature", action="store_true", help="Verify file signatures")
    p.add_argument("--auto-reload", action="store_true", help="Auto-reload enforcer cache")
    p.add_argument("--fail-closed", action="store_true", help="Fail closed if registry corrupted")
...
def load_registry_safely(file_path: Path) -> Tuple[bool, Optional[Dict[str, Any]], Optional[str]]:
...
def restore_from_backup(backup_file: Path, registry_file: Path) -> Tuple[bool, Optional[str]]:
