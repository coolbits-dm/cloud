...
def test_enforcer():
    ...
    try:
        ...
        result = enforce_request("nha:rag-ingest-worker", "rag:ingest", {}, scope="write:vectors")
        ...
        print(f"✅ Enforcement modes: MODE={MODE}, FAIL_CLOSED={FAIL_CLOSED}, ALLOW_WARN={ALLOW_WARN}")
